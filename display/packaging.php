...
<html class="no-js" lang="en">
	<head>    	
  	...
  	<body>
		<!-- Edit Packaging -->
			<div id="editPackagingSection" class="large-4 hidden"> <!-- class="large-4 columns hidden"> -->
		  		<div class="panel">
		  			<div class="h3">Edit Packaging</div>
		  			<p></p>
		  			<div class="row">
					...
					<div class="row ">
						  ...
						  <li><a id="updatePackagingButton" class="tiny button">Update Packaging</a></li>
						</ul>
					</div>
		  		</div>
		  	</div>
			...
			<!-- Search Bar / Inventory Table --> 
		  			<div class="large-7 medium-4 columns">
						<table id="packagingTable" class="display">
						 	<thead>
							    <tr>
									<th>ID</th>
									<th>UPC</th>
